...
public class RepositorioRotaLista implements RepositorioRota {
    private Rota rota;
    private RepositorioRotaLista proximo;

    //Construtor da lista
    public RepositorioRotaLista() {
        this.rota = null;
        this.proximo = null;
    }
    ...
    public void inserir(Rota rota) {
        if (this.rota == null) {
            this.rota = rota;
            this.proximo = new RepositorioRotaLista();
        } else {
